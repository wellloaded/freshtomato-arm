...
<head>
	...
	<% css(); %>
		...
		<script>
			...
			var bind_has_extsw = 0;

			function calcWanPortCount() {
				var count = 0;
				var wanIfnameVars = ['wan_ifnameX', 'wan2_ifnameX', 'wan3_ifnameX', 'wan4_ifnameX'];

				for (var i = 0; i < wanIfnameVars.length; ++i) {
					var ifname = nvram[wanIfnameVars[i]];
					if (ifname && (ifname.indexOf('vlan') === 0))
						++count;
				}
			...
			function portCaption(i) {
				...
				if (!orig)
					orig = (wanCount > 0) ? ('LAN' + (i - wanCount)) : ('LAN' + i);
			...
			/* MIPSR2P-END */
			/* REMOVE-BEGIN */
			var bind_is_mips_boardtype = (
				(nvram['boardtype'] == '0x0467') ||
				(nvram['boardtype'] == '0x048e') ||
				(nvram['boardtype'] == '0x04ef') ||
				(nvram['boardtype'] == '0x04cf') ||
				(nvram['boardtype'] == '0xf52c') ||
				(nvram['boardtype'] == '0xa4cf') ||
				(nvram['boardtype'] == '0xd4cf')
			);
			/* REMOVE-END */
			/* REMOVE-BEGIN */
			if (bind_is_mips_boardtype) {
				/* REMOVE-END */
				/* MIPSR2P-NO-BEGIN */
				...
				<td id="content">
					...
					<div id="unknown_router" style="display:none">
						...
						<div class="section-centered">
							<a href="https://www.linksysinfo.org/index.php?threads/can-vlan-gui-port-order-be-corrected.70160/#post-247634"
								class="new_window"><b>Please follow this link for instructions to get it
									corrected.</b></a>
							<br><br>Include router Brand/Model (<% nv('t_model_name'); %>), results from "nvram show |
								grep vlan1ports" &amp;
					...
					<div id="sesdiv" style="display:none">
							...
							<script>
								...
								for (var uidx = 0; uidx < wl_ifaces.length; ++uidx) {
									...
									if (u) {
										...
										f.push({
											title: wl_display_ifname(uidx), name: 'f_bridge_wlan' + uidx + '_to', type: 'select',
						...
						<div class="section-title">Notes <small><i><a
										href="javascript:toggleVisibility(cprefix,'notes');" id="toggleLink-notes"><span
											id="sesdiv_notes_showhide">(Show)</span></a></i></small></div>
						<div class="section" id="sesdiv_notes" style="display:none">
							<div>*** If you notice that the order of the LAN Ports are incorrect, try the <a
									href="basic-network.asp">Invert Ports Order</a> first, if not read <a
									href="https://www.linksysinfo.org/index.php?threads/can-vlan-gui-port-order-be-corrected.70160/#post-247634"
									target="_blank" rel="noopener noreferrer"> <b>this</b></a> ***</div>
							<br>
							VLAN Ethernet:
							<ul>
							...
							<br>
							<!-- RTNPLUS-NO-BEGIN -->
							<div><i>VID Offset:</i> First 802.1Q VLAN tag to be used as <i>base/initial tag/VID</i> for
								VLAN and VID assignments. This allows using VIDs larger than 15 on (older) devices, in
								contiguous blocks/ranges with up to 16 VLANs/VIDs. Set to '0' (zero) to disable this
								feature and VLANs will have the very same/identical value for its VID, as usual (from 0
								to 15).</div>
							<br>
							<!-- RTNPLUS-NO-END -->
							Wireless bridging:
							<ul>
								<li><b>Wireless interface to LAN bridge</b> - Maps each wireless interface
									(physical/virtual) to its LAN bridge</li>
							</ul>
							<br>
							Tips:
							<ul>
								<li>Cross check settings on the <a href="basic-network.asp">Network</a> and <a
										href="advanced-wlanvifs.asp">Virtual Wireless</a> pages</li>
